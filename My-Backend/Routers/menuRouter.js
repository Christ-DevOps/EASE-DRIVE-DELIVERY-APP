...
router.post('/Addmenu', authorize('partner'),upload.uploadMenuSingle,  menuCtrl.createMenu);
router.get('/mymenus', authorize('partner'), menuCtrl.getMenus);
router.put('/updatemenu/:id', authorize('partner'), upload.uploadMenuSingle, menuCtrl.updateMenu);
