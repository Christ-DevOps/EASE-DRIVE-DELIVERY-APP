...
export const NavigationProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigateToRestaurant = (id: string) => router.push(`/(main)/resto/restaurantDetails`);
  const navigateToMealDetails = (id: string) => router.push(`/`);
...
const navigateToLocationAccess = () => router.push('/location/LocatioAccess');
const navigateToFeedback = () => router.push('/(main)/reviews/Feedback');
