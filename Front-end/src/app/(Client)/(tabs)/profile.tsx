    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.menuContainer} showsVerticalScrollIndicator={false} >
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={()=> router.push('/Profile/EditAddress')} >
            <View style={styles.menuIcon}>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={()=> router.push('/(Client)/(tabs)/ViewCart')}>
            <View style={styles.menuIcon}>
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={()=> router.push('/(Client)/(screens)/feedback/Feedback')} >
            <View style={styles.menuIcon}>
